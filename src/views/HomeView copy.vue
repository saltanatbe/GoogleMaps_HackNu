...
export default {
  ...
  mounted() {
    ...
    function initWebGLOverlayView(map) {
      ...
      var findLocButton = document.getElementById("findLocation");
      var findMyLocation = document.getElementById("findMyLocation");

      findLocButton.onclick = async function (event) {
      ...
      findMyLocation.onclick = async function (event) {
        navigator.geolocation.getCurrentPosition(
          (position) => {
            console.log(position.coords.latitude);
            console.log(position.coords.longitude);
            this.formValues.Latitude = position.coords.latitude;
            this.formValues.Longitude = position.coords.longitude;
            let alt = prompt(
...
<template>
  ...
  <form id="fixed">
    ...
    <div class="form-group">
      <button type="submit" class="btn btn-primary" id="findLocation">
        Find location
      </button>
      <button class="btn btn-primary" id="findMyLocation">My Location</button>
